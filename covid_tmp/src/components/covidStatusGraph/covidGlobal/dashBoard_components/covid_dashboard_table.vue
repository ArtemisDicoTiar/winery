<template>
    <div id="continent_dashboard" class="dashboard">
...
<script>
    ...
    export default {
        name: 'continent_dashboard',
        beforeMount() {
            this.dataRequested = false
            this.$store.commit('covidDashBoard/SET_AREA_TYPE', 'global')
            this.$store.commit('covidDashBoard/SET_TARGET', 'continent')
